    ...
    return (
        ...
        <Form onSubmit={hSubmit} className="container col-sm-12 col-md-10 col-lg-8 col-xl-6 col-xxl-4 mt-5 text-start">
            <FormGroup row>
                ...
                <Col sm={10}>
                    <Input onChange={hChange} type="text" id="first_name" name="first_name" value={formData.first_name}/>
                </Col>
            ...
            <FormGroup row>
                ...
                <Col sm={10}>
                    <Input onChange={hChange} type="text" id="last_name" name="last_name" value={formData.last_name}/>
                </Col>
                <Col sm={{offset: 2, size: 10}}>
            ...
            <FormGroup row>
                ...
                <Col sm={10}>
                    <Input onChange={hChange} type="email" id="email" name="email" value={formData.email}/>
                </Col>
                <Col sm={{offset: 2, size: 10}}>
            ...
            <FormGroup row>
                ...
                <Col sm={10}>
                    <Input onChange={hChange} type="password" id="password" name="password" value={formData.password}/>
                </Col>
                <Col sm={{offset: 2, size: 10}}>
            ...
            <FormGroup row>
                <Col sm={{offset:2, size:10}}>
                    <Input onChange={hChange} type="checkbox" id="terms" name="terms" value="terms" checked={formData.terms}/>
                    {' '}
                    <Label htmlFor="terms">Terms</Label>
                </Col>
                <Col sm={{offset: 2, size: 10}}>
                    <div className="text-danger">{formErrors.terms}</div>
                </Col>
            </FormGroup>
            ...
            <FormGroup row>
                <Col sm={{ offset: 2, size: 10}}>
                    <div className="d-grid gap-1 col-12">
                        <input disabled={!isFormDataValid} className="btn btn-success" type="submit" value="Submit"/>
