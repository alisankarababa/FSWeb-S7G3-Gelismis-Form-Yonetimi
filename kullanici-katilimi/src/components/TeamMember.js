function TeamMember(props) {
    ...
    return (
        <div className="row my-2">
            <div className="border border-primary-subtle col-3">{member.first_name}</div>
            <div className="border border-primary-subtle col-3">{member.last_name}</div>
            ...
            <div className="border border-primary-subtle col-1"><button onClick={()=>hMemberToBeEdited(member)} type="button" className="btn btn-success">Edit</button></div>
        </div>
    );
}
